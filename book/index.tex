...
\\[8pt]
\normalsize
译者：\href{https://github.com/xiaoweiChen/Cpp23-Best-Practices}{陈晓伟}
\\[8pt]
\end{center}
...
\myPartGray{第一部分}{引言与理念}{content/part1/part.tex}
\newpage

\myChapter{1}{该版导论}{content/part1/1.tex}
\newpage

\myChapter{2}{原版导论}{content/part1/2.tex}
\newpage
...
\myChapter{5}{AI 编程}{content/part1/5.tex}
\newpage

\myChapter{6}{C++ 并非魔法}{content/part1/6.tex}
\newpage

\myChapter{7}{牢记：C++ 并非面向对象}{content/part1/7.tex}
\newpage
...
\myChapter{11}{避免未定义行为}{content/part1/11.tex}
\newpage
...
\myChapter{18}{自定义静态分析}{content/part2/18.tex}
\newpage

\myChapter{19}{消杀器}{content/part2/19.tex}
\newpage

\myChapter{20}{代码加固}{content/part2/20.tex}
\newpage

\myChapter{21}{多个编译器}{content/part2/21.tex}
\newpage
...
\myPartGray{第三部分}{API 与设计准则}{content/part3/part.tex}
\newpage

\myChapter{25}{难以误用}{content/part3/25.tex}
\newpage

\myChapter{26}{API 错误使用是否会引发未定义行为}{content/part3/26.tex}
\newpage

\myChapter{27}{警惕全局状态}{content/part3/27.tex}
\newpage

\myChapter{28}{更强的类型}{content/part3/28.tex}
\newpage

\myChapter{29}{[[nodiscard]]}{content/part3/29.tex}
\newpage

\myChapter{30}{再见，头文件！}{content/part3/30.tex}
\newpage

\myChapter{31}{保持导出模块重载的一致性}{content/part3/31.tex}
\newpage

\myChapter{32}{优先使用栈}{content/part3/32.tex}
\newpage
...
\myChapter{36}{使用概念约束模板参数}{content/part3/36.tex}
\newpage
...
\myChapter{40}{手动管理资源，请遵循“五规则”}{content/part3/40.tex}
\newpage

\myPartGray{第四部分}{实现准则}{content/part4/part.tex}
\newpage

\myChapter{41}{不要复制粘贴}{content/part4/41.tex}
\newpage

\myChapter{42}{优先使用 format}{content/part4/42.tex}
\newpage

\myChapter{43}{使用 constexpr}{content/part4/43.tex}
\newpage

\myChapter{44}{将头文件中的全局变量声明为 inline constexpr}{content/part4/44.tex}
\newpage

\myChapter{45}{对非 constexpr 变量使用 const}{content/part4/45.tex}
\newpage
...
\myChapter{48}{使用范围和视图提高正确性和可读性}{content/part4/48.tex}
\newpage

\myChapter{49}{不要重复使用视图}{content/part4/49.tex}
\newpage

\myChapter{50}{优先使用算法}{content/part4/50.tex}
\newpage

\myChapter{51}{视图和标准算法无用时，使用范围 for 循环}{content/part4/51.tex}
\newpage

\myChapter{52}{范围 for 循环中使用 auto}{content/part4/52.tex}
\newpage

\myChapter{53}{避免在 switch 中使用 default}{content/part4/53.tex}
\newpage

\myChapter{54}{优先使用作用域枚举}{content/part4/54.tex}
\newpage

\myChapter{55}{优先使用 if constexpr}{content/part4/55.tex}
\newpage

\myChapter{56}{泛型代码去模板化}{content/part4/56.tex}
\newpage

\myChapter{57}{使用 Lippincott 函数}{content/part4/57.tex}
\newpage

\myChapter{58}{再见，new！}{content/part4/58.tex}
\newpage
