...
\begin{myTip}{}
在某些情况下，创建结构体甚至可能提升性能，详见 C++ Weekly Ep 119《负成本结构体》\footnote{\url{https://youtu.be/FwsO12x8nyM}}。
\end{myTip}
...
C++11 中的 enum class 提供了一种简便的方式，可以实现更强的类型检查，避免使用布尔参数，并使您的 API 更难被误用。
...
\begin{itemize}
\item
C++ Weekly Ep 107: “=delete 的威力”\footnote{\url{https://youtu.be/aAvjUU0m6AU}}
