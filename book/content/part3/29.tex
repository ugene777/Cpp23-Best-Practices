...
阅读 Reddit 上的讨论 “An Argument Pro Liberal Use Of nodiscard”\footnote{\url{https://www.reddit.com/r/cpp/comments/9us7f3/an_argument_pro_liberal_use_of_nodiscard/}}。审视您自己的类型和函数。哪些返回值应该标记为 [[nodiscard]]？
...
\begin{itemize}
\item
“An Argument Pro Liberal Use Of nodiscard”\footnote{\url{https://www.reddit.com/r/cpp/comments/9us7f3/an_argument_pro_liberal_use_of_nodiscard/}}

\item
C++ Weekly Ep 30: C++17 的 [[nodiscard]] 属性\footnote{\url{https://youtu.be/l_5PF3GQLKc}}

\item
C++ Weekly Ep 199: C++20 的 [[nodiscard]] 构造函数及其用途\footnote{\url{https://youtu.be/E_ROB_xUQQQ}}
\end{itemize}
