C++11 引入了作用域枚举，旨在解决从 C 语言继承而来的 enum 的许多常见问题。
...
这些 enum class 版本的枚举在没有刻意为之的情况下很难混淆，并且其标识符现在是受作用域限制的，不再是全局的。

\begin{shell}
enum struct 和 enum class 等价。从逻辑上讲，enum struct 更合理，因其名称公开。你更喜欢哪一个呢？
\end{shell}
...
\begin{itemize}
\item
CppCon 2018: Victor Ciura “Clang 工具箱中的更好工具”\footnote{\url{https://youtu.be/4X_fZkl7kkU}} (讨论了迁移到 enum class 时发现的 bug)
