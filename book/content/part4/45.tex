...
\begin{itemize}
\item
CppCon 2014: James McNellis \& Kate Gregory “Modernizing Legacy C++ Code”\footnote{\url{https://youtu.be/LDxAgMe6D18}}

\item
CppCon 2019: Jason Turner “C++ Code Smells”\footnote{\url{https://youtu.be/f_tLQl0wLUM}}

\item
C++ 中 const 或引用成员变量的影响\footnote{\url{https://lesleylai.info/en/const-and-reference-member-variables/}}

\item
C++Now 2018: Ben Deane “Easy to Use, Hard to Misuse: Declarative Style in C++”\footnote{\url{https://youtu.be/2ouxETt75R4}}（建立在使 const 更易应用的技术之上。）
\end{itemize}
